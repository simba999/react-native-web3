...
class LoginScreen extends React.Component {
  ...
  constructor() {
    ...
    // this.web3 = new Web3(new Web3.providers.HttpProvider('http://192.168.1.131:8545'));
  ...
  componentDidMount() {
    ...
    // contract.getProduc(t'0xaeea63b5479b50f79583ec49dacdcf86ddeff392', (err, res) => {
    //   debugger;
    // })
  }

  toHomeScreen = (address) => this.props.navigation.dispatch(resetTo({ routeName: 'MainDrawer', params: {address: address} }))
